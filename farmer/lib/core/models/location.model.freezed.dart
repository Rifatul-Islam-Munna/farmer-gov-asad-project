...
mixin _$LocationModel {
 ...
 String? get address; String? get district; String? get division; double? get latitude; double? get longitude;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,address,district,division,latitude,longitude);

@override
String toString() {
  return 'LocationModel(address: $address, district: $district, division: $division, latitude: $latitude, longitude: $longitude)';
}
...
@useResult
$Res call({
 String? address, String? district, String? division, double? latitude, double? longitude
});
...
/// Create a copy of LocationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? address = freezed,Object? district = freezed,Object? division = freezed,Object? latitude = freezed,Object? longitude = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? address,  String? district,  String? division,  double? latitude,  double? longitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocationModel() when $default != null:
return $default(_that.address,_that.district,_that.division,_that.latitude,_that.longitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? address,  String? district,  String? division,  double? latitude,  double? longitude)  $default,) {final _that = this;
switch (_that) {
case _LocationModel():
return $default(_that.address,_that.district,_that.division,_that.latitude,_that.longitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? address,  String? district,  String? division,  double? latitude,  double? longitude)?  $default,) {final _that = this;
switch (_that) {
case _LocationModel() when $default != null:
return $default(_that.address,_that.district,_that.division,_that.latitude,_that.longitude);case _:
  return null;
...
class _LocationModel implements LocationModel {
  const _LocationModel({this.address, this.district, this.division, this.latitude, this.longitude});
...
/// Create a copy of LocationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? address = freezed,Object? district = freezed,Object? division = freezed,Object? latitude = freezed,Object? longitude = freezed,}) {
